...
def bubble_sort(array)
    ...
    loop do
        ...
        (n -1).times do |i|
            if array[i] > array[i + 1] #Verifica-se o elemento atual é maior que o pro]óximo.
            array[i], array[i + 1], array[i]
            swapped = true # Indica que uma troca foi realizada.
            end 
        end
        break unless swapped # Sai do loop se se nenhuma troca foi realizada,indicando que o array está ordenado.
    end

    array # Retorna o array ordenado.
end

array = [64, 34, 25, 12, 11, 90] # Array de exemplo.
sorted_array = bubble_sort(array) # Chama o método bubble_sort para ordenar o array.
